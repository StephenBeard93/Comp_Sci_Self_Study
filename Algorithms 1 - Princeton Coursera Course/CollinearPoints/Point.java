...
public class Point implements Comparable<Point> {
    ...
    public Comparator<Point> slopeOrder() {
        slopeComparator returnThis = new slopeComparator(this.x, this.y);
        return returnThis;
    }
    ...
    public static void main(String[] args) {
        ...
        test.drawTo(a);
        double slope = test.slopeTo(a);
        System.out.println(slope);
        System.out.println(test.compareTo(a));
        Comparator<Point> testComparator = test.slopeOrder();
        System.out.println(testComparator.compare(a,b));
    }
}